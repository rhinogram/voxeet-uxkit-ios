...
extension ConferenceViewController: VTConferenceDelegate {
    ...
    func participantAdded(participant: VTParticipant) {
        ...
        NotificationCenter.default.post(name: Notification.Name("participantAdded"), object: nil, userInfo: ["participantId": participant.id])
    }

    func participantUpdated(participant: VTParticipant) {
        NotificationCenter.default.post(name: Notification.Name("participantUpdated"), object: nil, userInfo: ["participantId": participant.id])
    }
    ...
    func streamAdded(participant: VTParticipant, stream: MediaStream) {
        ...
        NotificationCenter.default.post(name: Notification.Name("streamAdded"), object: nil, userInfo: ["stream": stream.id])
    }
    ...
    func streamUpdated(participant: VTParticipant, stream: MediaStream) {
        ...
        NotificationCenter.default.post(name: Notification.Name("streamUpdated"), object: nil, userInfo: ["stream": stream.id])
    }
    ...
    func streamRemoved(participant: VTParticipant, stream: MediaStream) {
        ...
        NotificationCenter.default.post(name: Notification.Name("streamRemoved"), object: nil, userInfo: ["stream": stream.id])
    }
